...
const Signup = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col md:flex-row">
      ...
      {/* Right side div */}
      <div className="w-full md:w-1/2 h-full bg-white flex flex-col p-6 md:p-12 lg:p-20 justify-between items-center">
          ...
          <form onSubmit={handleSubmit}>
            <div className="w-full flex flex-col">
              ...
              <div className="w-full flex flex-col my-2 md:my-4">
                ...
                <div className="flex flex-wrap justify-center gap-6 md:gap-2">
